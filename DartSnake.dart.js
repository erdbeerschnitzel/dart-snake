...
Isolate.$defineClass("mc", "Object", ["_intervalId", "ball", "snake"], {
 onKeyPress$1: function(event$) {
  $0:{
    var t0 = event$.get$keyCode();
    if (38 === t0) {
      this.snake.set$direction('up');
      var t1 = this.snake;
      t1.set$pos_Y($.sub(t1.get$pos_Y(), 10));
      break $0;
    } else {
      if (40 === t0) {
        this.snake.set$direction('down');
        var t2 = this.snake;
        t2.set$pos_Y($.add(t2.get$pos_Y(), 10));
        break $0;
      } else {
        if (37 === t0) {
          this.snake.set$direction('left');
          var t3 = this.snake;
          t3.set$pos_X($.sub(t3.get$pos_X(), 10));
          break $0;
        } else {
          if (39 === t0) {
            this.snake.set$direction('right');
            var t4 = this.snake;
            t4.set$pos_X($.add(t4.get$pos_X(), 10));
            break $0;
          } else {
          }
        }
 ...
 get$onKeyPress: function() { return new $.Closure12(this); },
 writeStatus$1: function(message) {
  $.document().query$1('#snake').set$innerHTML(message);
 },
 write$1: function(message) {
  $.document().query$1('#status').set$innerHTML(message);
 },
 drawSnake$0: function() {
  ...
  $0:{
    var t0 = this.snake.get$direction();
    if ('left' === t0) {
      ctx.set$fillStyle('red');
      ctx.fillRect$4(this.snake.get$pos_X(), this.snake.get$pos_Y(), 1, 10);
      ctx.set$fillStyle('black');
      for (var i = 1; $.ltB(i, $.get$length(this.snake.get$parts())); i = i + 1) {
        ctx.fillRect$4($.add(this.snake.get$pos_X(), i), this.snake.get$pos_Y(), 1, 10);
      }
      break $0;
    } else {
      if ('right' === t0) {
        ...
        ctx.fillRect$4(this.snake.get$pos_X(), this.snake.get$pos_Y(), 1, 10);
        ctx.set$fillStyle('black');
        for (var i0 = 1; $.ltB(i0, $.get$length(this.snake.get$parts())); i0 = i0 + 1) {
          ctx.fillRect$4($.sub(this.snake.get$pos_X(), i0), this.snake.get$pos_Y(), 1, 10);
        }
        break $0;
      } else {
        if ('up' === t0) {
          ctx.set$fillStyle('red');
          ctx.fillRect$4(this.snake.get$pos_X(), this.snake.get$pos_Y(), 10, 1);
          ctx.set$fillStyle('black');
          for (var i1 = 1; $.ltB(i1, $.get$length(this.snake.get$parts())); i1 = i1 + 1) {
            ctx.fillRect$4(this.snake.get$pos_X(), $.add(this.snake.get$pos_Y(), i1), 10, 1);
          }
          break $0;
        } else {
          if ('down' === t0) {
            ...
            ctx.fillRect$4(this.snake.get$pos_X(), this.snake.get$pos_Y(), 10, 1);
            ctx.set$fillStyle('black');
            for (var i2 = 1; $.ltB(i2, $.get$length(this.snake.get$parts())); i2 = i2 + 1) {
              ctx.fillRect$4(this.snake.get$pos_X(), $.sub(this.snake.get$pos_Y(), i2), 10, 1);
            }
            break $0;
          } else {
          }
  ...
  if (this.snake.touchesWall$1(drawingArea) === true) {
    this.writeStatus$1('Game over!');
    $.document().get$window().get$localStorage().$dom_setItem$2('highscore', $.toString(this.snake.get$points()));
    $.document().get$window().clearInterval$1(this._intervalId);
    $.document().get$on().get$keyPress().remove$1(this.get$onKeyPress());
  } else {
    this.writeStatus$1($.add($.add($.add($.add($.add('ball pos: ', $.toInt(this.ball.get$pos_X())) + ', ', $.toInt(this.ball.get$pos_Y())) + ' to the ', this.snake.get$direction()) + ' --> x: ', this.snake.get$pos_X()) + ' y: ', this.snake.get$pos_Y()));
  }
  if (this.snake.catches$1(this.ball) === true) {
    this.write$1($.add('Points: ', this.snake.get$points()));
    this.ball = $.Ball$0();
  } else {
  }
 },
 get$drawSnake: function() { return new $.Closure13(this); },
 mc$0: function() {
  $.add$1($.document().get$on().get$keyPress(), this.get$onKeyPress());
  if (!$.eqNullB($.document().get$window().get$localStorage().$dom_getItem$1('highscore'))) {
    this.write$1($.add('Previous Score: ', $.document().get$window().get$localStorage().$dom_getItem$1('highscore')));
  } else {
  }
  this.snake = $.Snake$0();
  this.ball = $.Ball$0();
  this._intervalId = $.document().get$window().setInterval$2(this.get$drawSnake(), 5);
 }
});

Isolate.$defineClass("Snake", "Object", ["parts?", "pending_direction", "color", "direction=", "points?", "pos_Y=", "pos_X=", "width?"], {
 touchesWall$1: function(canvas) {
  var t0 = $.leB(this.pos_X, 3);
  if (!t0) {
    var t1 = $.geB(this.pos_X, $.sub(canvas.get$width(), 3));
  } else {
    t1 = t0;
  }
  if (!t1) {
    var t2 = $.leB(this.pos_Y, 2);
  } else {
    t2 = t1;
  }
  if (!t2) {
    var t3 = $.geB(this.pos_Y, $.sub(canvas.get$height(), 3));
  } else {
    t3 = t2;
  }
  if (t3) {
 ...
 catches$1: function(ball) {
  var t0 = $.geB(ball.get$pos_Y(), $.sub(this.pos_Y, 10));
  if (t0) {
    var t1 = $.leB(ball.get$pos_Y(), $.add(this.pos_Y, 10));
  } else {
    t1 = t0;
  }
  if (t1) {
    var t2 = $.leB(ball.get$pos_X(), $.add(this.pos_X, 10));
  } else {
    t2 = t1;
  }
  if (t2) {
    var t3 = $.geB(ball.get$pos_X(), $.sub(this.pos_X, 10));
  } else {
    t3 = t2;
  }
  if (t3) {
    this.increaseLength$1(5);
    this.points = $.add(this.points, 1);
    return true;
  } else {
  }
  return false;
 },
 increaseLength$1: function(length$) {
  if (typeof length$ !== 'number') return this.increaseLength$1$bailout(length$,  0);
  for (var i = 0; i < length$; i = i + 1) {
    $.add$1(this.parts, 1);
  }
 },
 increaseLength$1$bailout: function(length$, state, env0) {
  switch (state) {
    case 1:
      t0 = env0;
      break;
...
Isolate.$defineClass("Ball", "Object", ["size?", "pos_Y=", "pos_X="], {
 Ball$0: function() {
  this.pos_X = $.abs($.add(2, $.mul($.mul($.random(), $.random()), 400)));
  this.pos_Y = $.abs($.add(2, $.mul($.mul($.random(), $.random()), 400)));
  for (; $.gtB(this.pos_X, 300); ) {
    this.pos_X = $.toInt($.div(this.pos_X, 2));
  }
  for (; $.gtB(this.pos_Y, 300); ) {
    this.pos_Y = $.toInt($.div(this.pos_Y, 2));
  }
  if ($.ltB(this.pos_X, 5)) {
    this.pos_X = $.add(this.pos_X, 10);
  } else {
  }
  if ($.ltB(this.pos_Y, 5)) {
    this.pos_Y = $.add(this.pos_Y, 10);
  } else {
  }
 }
});
...
Isolate.$defineClass("FilteredElementList", "Object", ["_childNodes", "_node"], {
 ...
 get$add: function() { return new $.Closure14(this); },
...
Isolate.$defineClass("_ChildrenElementList", "Object", ["_childElements", "_element"], {
 ...
 filter$1: function(f) {
  ...
  t0.f_1 = f;
  var output = [];
  this.forEach$1(new $.Closure6(t0, output));
...
Isolate.$defineClass("Closure2", "Closure11", ["box_0"], {
 $call$0: function() {
  return this.box_0.closure_1.$call$1(this.box_0.arg1_2);
 }
});

Isolate.$defineClass("Closure3", "Closure11", ["box_0"], {
 $call$0: function() {
  return this.box_0.closure_1.$call$2(this.box_0.arg1_2, this.box_0.arg2_3);
 }
});

Isolate.$defineClass("Closure4", "Closure11", ["box_0"], {
 $call$2: function(k, v) {
...
Isolate.$defineClass("Closure5", "Closure11", [], {
 $call$1: function(n) {
  return typeof n === 'object' && n.is$Element();
 }
});

Isolate.$defineClass("Closure6", "Closure11", ["box_0", "output_2"], {
...
Isolate.$defineClass("Closure7", "Closure11", [], {
 $call$1: function(el) {
  return el.remove$0();
 }
});
...
Isolate.$defineClass('Closure12', 'Closure11', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.onKeyPress$1(arg0); }
});
Isolate.$defineClass('Closure13', 'Closure11', function BoundClosure(self) { this.self = self; }, {
 $call$0: function() { return this.self.drawSnake$0(); }
});
...
$.Snake$0 = function() {
  var t0 = new $.Snake((void 0), 'right', 'black', 'right', 0, (void 0), (void 0), 10);
  t0.Snake$0();
  return t0;
};
...
$.mc$0 = function() {
  var t0 = new $.mc((void 0), (void 0), (void 0));
  t0.mc$0();
  return t0;
};
...
$.Ball$0 = function() {
  var t0 = new $.Ball(15, (void 0), (void 0));
  t0.Ball$0();
  return t0;
};
...
$.$defineNativeClass('WebKitAnimation', ["direction?"], {
});
...
$.$defineNativeClass('HTMLInputElement', ["width?", "size?", "pattern?", "height?"], {
 get$on: function() {
...
$.$defineNativeClass('HTMLSelectElement', ["size?", "length="], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('DOMWindow', ["window?", "navigator?", "localStorage?", "length?"], {
